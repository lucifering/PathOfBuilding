...
controls.github = common.New("ButtonControl", nil, 0, 64, 340, 18, "gitee page: ^x4040FFhttps://github.com/lucifering/PathOfBuilding", function(control)
OpenURL("https://github.com/lucifering/PathOfBuilding")
	end)
