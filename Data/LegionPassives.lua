...
return {
	...
	["nodes"] = {
		...
		["karui_keystone_3_v2"] = {
			...
			["sd"] = {
				[1] = "每秒再生 3 点怒火", 
				[2] = "魔力再生率的加快和减慢效果也作用与怒火再生速度", 
				[3] = "你击中敌人时失去 5 点怒火，每 0.3 秒只发生一次", 
			}, 
			["dn"] = "破枷除锁", 
			["isJewelSocket"] = false, 
			["m"] = false, 
		...
		["vaal_keystone_3"] = {
			...
			["not"] = false, 
			["sd"] = {
				[1] = "受到的非混沌伤害有 50% 穿透能量护盾", 
				[2] = "获得等同 20% 最大生命的额外最大能量护盾", 
			}, 
			["dn"] = "腐化的灵魂", 
			["isJewelSocket"] = false, 
			["m"] = false, 
		...
		["maraketh_keystone_1"] = {
			...
			["not"] = false, 
			["sd"] = {
				[1] = "近期内如果没有被击中，则承受的伤害降低 20%", 
				[2] = "近期内如果没有被击中，则闪避值降低 40%", 
				[3] = "如果近期内被击中，则总闪避值额外提高 20%", 
			}, 
			["dn"] = "风舞者", 
			["isJewelSocket"] = false, 
			["m"] = false, 
