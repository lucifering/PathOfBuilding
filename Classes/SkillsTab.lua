...
local alternateGemQualityList ={
	{label = "默认品质", type = "Default"},
	{label = "特殊品质 1", type = "Alternate1"},
	{label = "特殊品质 2", type = "Alternate2"},
	{label = "特殊品质 3", type = "Alternate3"},
}
...
self.controls.groupTip = new("LabelControl", {"TOPLEFT",self.controls.groupList,"BOTTOMLEFT"}, 0, 8, 0, 14, "^7提示: 可以使用 Ctrl+C 和 Ctrl+V 来复制和粘贴技能组.")
	...
	-- Gem options
self.controls.optionSection = new("SectionControl", {"TOPLEFT",self.controls.groupList,"BOTTOMLEFT"}, 0, 50, 300, 130, "技能选项")
