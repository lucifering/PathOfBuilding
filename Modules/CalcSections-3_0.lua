...
{ label = "攻击时间", flag = "attack", { format = "{2:output:Time}s", { breakdown = "MainHand.Time" }, }, },
...
{ label = "玩家加成", modName = { "EnemyPoisonDuration", "SkillAndDamagingAilmentDuration" }, cfg = "poison" },
		{ label = "敌人加成", modName = "SelfPoisonDuration", enemy = true },
	}, },
...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "元素异常", data = {
	...
	{ label = "【冰缓】效果提高", flag = "chill", { format = "{0:output:ChillEffectMod}%",
	...
	{ label = "【感电】效果提高", flag = "shock", { format = "{0:output:ShockEffectMod}%",
...
{ label = "天赋树的总【提高】", { format = "{0:mod:1}%", { modName = { "Evasion", "ArmourAndEvasion", "Defences" }, modType = "INC", modSource = "Tree" }, }, },
...
{ label = "近战闪避几率", { format = "{0:output:MeleeEvadeChance}%", 
		{ breakdown = "MeleeEvadeChance" },
		{ modName = { "CannotEvade" } },
		{ label = "敌人加成", modName = { "Accuracy", "HitChance" }, enemy = true },
	}, },
{ label = "投射物闪避几率", { format = "{0:output:ProjectileEvadeChance}%", 
