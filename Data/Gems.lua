...
return {
	...
	["Metadata/Items/Gems/SkillGemElementalHit"] = {
		...
		tagString = "攻击, 投射物, 近战, 打击, 火焰, 冰霜, 闪电, 范围效果, 弓箭",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemInfernalBlow"] = {
		...
		tagString = "攻击, 范围效果, 近战, 打击, 火焰, 持续时间",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalGlacialHammer"] = {
		...
		tagString = "瓦尔, 攻击, 近战, 打击, 持续时间, 范围效果, 冰霜",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemExplosiveArrow"] = {
		...
		tagString = "攻击, 投射物, 范围效果, 持续时间, 火焰, 弓箭",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemPunishment"] = {
		...
		tagString = "法术, 范围效果, 持续时间, 诅咒, 物理, 魔蛊",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVulnerability"] = {
		...
		tagString = "法术, 范围效果, 持续时间, 诅咒, 混沌, 魔蛊, 咒印",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemLightningWarp"] = {
		...
		tagString = "法术, 范围效果, 持续时间, 位移, 闪电, 旅行",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalLightningWarp"] = {
		...
		tagString = "瓦尔, 法术, 范围效果, 持续时间, 闪电, 位移, 旅行",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemMoltenShell"] = {
		...
		tagString = "法术, 范围效果, 持续时间, 火焰, 物理, 护卫",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalMoltenShell"] = {
		...
		tagString = "瓦尔, 法术, 范围效果, 持续时间, 火焰, 物理, 护卫",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalBurningArrow"] = {
		...
		tagString = "瓦尔, 攻击, 投射物, 范围效果, 火焰, 弓箭, 持续时间",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemFreezeMine"] = {
		...
		tagString = "地雷, 法术, 投射物, 冰霜, 光环, 范围效果",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemFlammability"] = {
		...
		tagString = "法术, 范围效果, 持续时间, 诅咒, 火焰, 魔蛊",
		reqStr = 40,
		reqDex = 0,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemFrostbite"] = {
		...
		tagString = "法术, 范围效果, 持续时间, 诅咒, 冰霜, 魔蛊",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemConductivity"] = {
		...
		tagString = "法术, 范围效果, 持续时间, 诅咒, 闪电, 魔蛊",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemStormBurst"] = {
		...
		tagString = "范围效果, 法术, 闪电, 持续吟唱, 持续时间, 物理",
		reqStr = 40,
		reqDex = 0,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemCyclone"] = {
		...
		tagString = "攻击, 范围效果, 位移, 持续吟唱, 物理, 近战",
		reqStr = 40,
		reqDex = 60,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalCyclone"] = {
		...
		tagString = "瓦尔, 攻击, 范围效果, 持续时间, 近战, 位移, 持续吟唱, 物理",
		reqStr = 40,
		reqDex = 60,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemSmokeMine"] = {
		...
		tagString = "地雷, 法术, 范围效果, 持续时间, 位移, 旅行, 闪现",
		reqStr = 0,
		reqDex = 60,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemMoltenStrike"] = {
		...
		tagString = "攻击, 投射物, 范围效果, 近战, 打击, 火焰",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemFireNovaMine"] = {
		...
		tagString = "地雷, 法术, 投射物, 火焰, 范围效果, 光环, 新星",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemStaticStrike"] = {
		...
		tagString = "攻击, 近战, 打击, 范围效果, 持续时间, 闪电, 连锁",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemAbyssalCry"] = {
		...
		tagString = "战吼, 范围效果, 持续时间, 火焰, 攻击, 近战",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemWildStrike"] = {
		...
		tagString = "攻击, 近战, 打击, 闪电, 冰霜, 火焰, 投射物, 范围效果, 连锁",
		reqStr = 40,
		reqDex = 60,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemOrbOfStorms"] = {
		...
		tagString = "闪电, 法术, 持续时间, 范围效果, 连锁, 法球",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemDarkPact"] = {
		...
		tagString = "召唤生物, 法术, 范围效果, 连锁, 混沌, 新星",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalEarthquake"] = {
		...
		tagString = "瓦尔, 攻击, 范围效果, 持续时间, 猛击, 近战",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalBlight"] = {
		...
		tagString = "瓦尔, 法术, 混沌, 范围效果, 持续时间, 新星, 持续吟唱",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/ConsecratedPath"] = {
		...
		tagString = "火焰, 攻击, 范围效果, 位移, 持续时间, 猛击, 近战",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/Smite"] = {
		...
		tagString = "闪电, 攻击, 范围效果, 持续时间, 近战, 打击, 光环",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemWinterOrb"] = {
		...
		tagString = "冰霜, 法术, 持续吟唱, 范围效果, 持续时间, 投射物, 法球",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemDarkRitual"] = {
		...
		tagString = "混沌, 触发, 法术, 范围效果, 持续时间, 魔蛊",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemPurge"] = {
		...
		tagString = "火焰, 闪电, 法术, 范围效果, 持续时间, 物理",
		reqStr = 40,
		reqDex = 0,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemFrostblink"] = {
		...
		tagString = "法术, 位移, 持续时间, 冰霜, 旅行, 闪现, 范围效果",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemWitheringStep"] = {
		...
		tagString = "旅行, 范围效果, 混沌, 位移, 闪现, 法术, 持续时间",
		reqStr = 0,
		reqDex = 60,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemSummonSkitterbots"] = {
		...
		tagString = "陷阱, 地雷, 法术, 召唤生物, 冰霜, 闪电, 范围效果, 光环",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemPestilentStrike"] = {
		...
		tagString = "攻击, 近战, 打击, 范围效果, 持续时间, 混沌",
		reqStr = 0,
		reqDex = 60,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemArtilleryBallista"] = {
		...
		tagString = "攻击, 图腾, 范围效果, 火焰, 投射物, 弓箭",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemStormBind"] = {
		...
		tagString = "法术, 范围效果, 持续吟唱, 闪电, 持续时间",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemPenanceBrand"] = {
		...
		tagString = "法术, 范围效果, 物理, 闪电, 持续时间, 烙印",
		reqStr = 40,
		reqDex = 0,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVoidSphere"] = {
		...
		tagString = "法术, 范围效果, 持续时间, 物理, 混沌, 法球",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
