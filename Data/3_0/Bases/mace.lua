...
itemBases["祭仪之杵"] = {
	...
	tags = { default = true, weapon = true, onehand = true, mace = true, one_hand_weapon = true, },
	implicit = "敌人晕眩门槛降低 10%",
	weapon = { PhysicalMin = 9, PhysicalMax = 14, CritChanceBase = 5, AttackRateBase = 1.35,  Range = 11,},
	req = { level = 5, str = 26, },
}
itemBases["钝钉木棒"] = {
	type = "One Handed Mace",
	...
	tags = { default = true, weapon = true, onehand = true, mace = true, one_hand_weapon = true, },
	implicit = "敌人晕眩门槛降低 10%",
	weapon = { PhysicalMin = 13, PhysicalMax = 17, CritChanceBase = 5, AttackRateBase = 1.4, Range = 11, },
	req = { level = 10, str = 41, },
}
itemBases["石锤"] = {
	type = "One Handed Mace",
	...
	weapon = { PhysicalMin = 17, PhysicalMax = 32, CritChanceBase = 5, AttackRateBase = 1.15,  Range = 11,},
	req = { level = 15, str = 56, },
}
itemBases["战锤"] = {
	type = "One Handed Mace",
	...
	tags = { default = true, weapon = true, onehand = true, mace = true, one_hand_weapon = true, },
	implicit = "敌人晕眩门槛降低 10%",
	weapon = { PhysicalMin = 14, PhysicalMax = 32, CritChanceBase = 5, AttackRateBase = 1.4,  Range = 11,},
	req = { level = 20, str = 71, },
}
itemBases["多刃锤"] = {
	type = "One Handed Mace",
	...
	tags = { default = true, weapon = true, onehand = true, mace = true, one_hand_weapon = true, },
	implicit = "敌人晕眩门槛降低 10%",
	weapon = { PhysicalMin = 22, PhysicalMax = 36, CritChanceBase = 5, AttackRateBase = 1.3,  Range = 11,},
	req = { level = 24, str = 83, },
}
itemBases["祭礼之锤"] = {
	type = "One Handed Mace",
...
itemBases["朽木短杖"] = {
	...
	implicit = "元素伤害提高 10%",
	weapon = { PhysicalMin = 6, PhysicalMax = 9, CritChanceBase = 6, AttackRateBase = 1.4, Range = 11, },
	req = { str = 8, int = 8, },
}
itemBases["乌木短杖"] = {
	type = "Sceptre",
...
itemBases["铜锻短杖"] = {
	...
	tags = { default = true, weapon = true, onehand = true, mace = true, one_hand_weapon = true, sceptre = true, },
	implicit = "元素伤害提高 12%",
	weapon = { PhysicalMin = 12, PhysicalMax = 23, CritChanceBase = 6, AttackRateBase = 1.25, Range = 11, },
...
itemBases["石英短杖"] = {
	...
	tags = { default = true, weapon = true, onehand = true, mace = true, one_hand_weapon = true, sceptre = true, },
	implicit = "元素伤害提高 20%",
	weapon = { PhysicalMin = 17, PhysicalMax = 26, CritChanceBase = 6.5, AttackRateBase = 1.25,  Range = 11,},
...
itemBases["冷铁短杖"] = {
	...
	tags = { default = true, weapon = true, onehand = true, mace = true, one_hand_weapon = true, sceptre = true, },
	implicit = "元素伤害提高 14%",
	weapon = { PhysicalMin = 21, PhysicalMax = 32, CritChanceBase = 6, AttackRateBase = 1.25,  Range = 11,},
...
itemBases["赤色短杖"] = {
	...
	tags = { default = true, weapon = true, onehand = true, mace = true, one_hand_weapon = true, sceptre = true, },
	implicit = "元素伤害提高 16%",
	weapon = { PhysicalMin = 17, PhysicalMax = 32, CritChanceBase = 6, AttackRateBase = 1.4,  Range = 11,},
...
itemBases["祭仪巨锤"] = {
	...
	tags = { default = true, weapon = true, twohand = true, mace = true, two_hand_weapon = true, },
	implicit = "敌人被晕眩时间延长 30%",
	weapon = { PhysicalMin = 15, PhysicalMax = 23, CritChanceBase = 5, AttackRateBase = 1.2,  Range = 13, },
	req = { level = 8, str = 35, },
}
itemBases["千斤锤"] = {
	type = "Two Handed Mace",
	...
	tags = { default = true, weapon = true, twohand = true, mace = true, two_hand_weapon = true, },
	implicit = "敌人被晕眩时间延长 30%",
	weapon = { PhysicalMin = 15, PhysicalMax = 30, CritChanceBase = 5, AttackRateBase = 1.25, Range = 13,  },
	req = { level = 12, str = 47, },
}
itemBases["冷铁重锤"] = {
	type = "Two Handed Mace",
...
itemBases["狼牙重锤"] = {
	...
	tags = { default = true, weapon = true, twohand = true, mace = true, two_hand_weapon = true, },
	implicit = "敌人被晕眩时间延长 30%",
	weapon = { PhysicalMin = 24, PhysicalMax = 45, CritChanceBase = 5, AttackRateBase = 1.25,  Range = 13, },
	req = { level = 22, str = 77, },
}
itemBases["铜影巨锤"] = {
	type = "Two Handed Mace",
