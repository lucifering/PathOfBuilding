...
itemBases["鲨颚爪"] = {
	...
	weapon = { PhysicalMin = 7, PhysicalMax = 18, CritChanceBase = 6.5, AttackRateBase = 1.4, Range = 11, },
...
itemBases["凿钉"] = {
	...
	weapon = { PhysicalMin = 7, PhysicalMax = 24, CritChanceBase = 6.3, AttackRateBase = 1.5, Range = 11, },
...
itemBases["袭眼钩"] = {
	...
	weapon = { PhysicalMin = 12, PhysicalMax = 32, CritChanceBase = 6.3, AttackRateBase = 1.5, Range = 11, },
