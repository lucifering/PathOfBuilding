...
name = "狙击",
	hidden = true,
	color = 2,
description = "对目标射出一发高伤害且必中的箭矢. 此攻击速度缓慢且会被路径上的敌人所阻挡, 并可藉由释放狂怒球而增加攻击速度.",
...
name = "灵枢行走",
	hidden = true,
	color = 4,
description = "你在移动中时，每秒在身后唤起一具灵枢。",
...
description = "对目标造成物理及火焰伤害, 并在挥击的途中从武器弹射出熔岩球. 这些熔岩球在着地时会爆炸, 并对附近的敌人造成伤害. ",
	skillTypes = { [SkillType.Projectile] = true, [SkillType.Attack] = true, [SkillType.Area] = true, [SkillType.FireSkill] = true, [SkillType.Triggerable] = true, [SkillType.Triggered] = true, [SkillType.ProjectileAttack] = true, [SkillType.Type83] = true, [SkillType.SecondWindSupport] = true, },
	statDescriptionScope = "skill_stat_descriptions",
	castTime = 1,
	fromItem = true,
	baseFlags = {
...
skills["CastAuraBlinding"] = {
	...
	skillTypes = { [SkillType.Spell] = true, [SkillType.Area] = true, [SkillType.Buff] = true, [SkillType.ManaCostReserved] = true, [SkillType.ManaCostPercent] = true, [SkillType.Aura] = true, [SkillType.AuraDebuff] = true, [SkillType.Triggerable] = true, [SkillType.Triggered] = true, [SkillType.TriggeredGrantedSkill] = true, [SkillType.AreaSpell] = true, },
	statDescriptionScope = "aura_skill_stat_descriptions",
	castTime = 1.2,
	fromItem = true,
	baseFlags = {
	...
	levels = {
		[20] = { 1, levelRequirement = 1, statInterpolation = { 1, }, },
	},
}
...
skills["FeastOfFlesh"] = {
	...
	levels = {
		[15] = { 10, 400, 200, 400, levelRequirement = 70, statInterpolation = { 1, 1, 1, 1, }, },
	},
}
