...
{ 1, "Crit", 1, "暴击", colorCodes.OFFENCE, {
	...
	flag = "hit",
	-- Skill
{ label = "提高暴击几率", notFlag = "attack", { format = "{0:mod:1}%", { modName = "CritChance", modType = "INC", cfg = "skill" }, }, },
...
{ label = "最大连锁数量", flag = "chaining", { format = "{0:output:ChainMax}", { modName = "ChainCountMax", cfg = "skill" }, }, }, 
{ label = "投射物数量", flag = "projectile", { format = "{0:output:ProjectileCount}", { modName = "ProjectileCount", cfg = "skill" }, }, },
{ label = "穿透数量", flag = "projectile", { format = "{output:PierceCountString}", { modName = { "PierceCount", "PierceAllTargets" }, cfg = "skill" }, }, },
...
{ label = "范围效果加成", flag = "area", { format = "x {2:output:AreaOfEffectMod}", 
...
{ label = "有效 DPS 加成", flag = "effective", { format = "x {3:output:BleedEffMult}", { breakdown = "BleedEffMult" }, { label = "Enemy modifiers", modName = { "DamageTaken", "DamageTakenOverTime", "PhysicalDamageTaken", "PhysicalDamageTakenOverTime", "PhysicalDamageReduction" }, enemy = true }, }, },
