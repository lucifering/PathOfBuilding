...
description = "活化一把【近战武器】或【徘徊之刃】为你而战，无法活化未鉴定的物品。只有特别指定后才能活化有 6 个插槽的物品。",
...
name = "瓦尔.箭雨",
	color = 2,
description = "向空中射出多支箭矢，飞行一段时间后陆续抵达，先发射至一个指定位置，抵达后向四面八方展开。每支箭矢会对其周围区域造成伤害。若范围内有目标，则一半数量的箭矢会直接飞向目标。",
	skillTypes = { [SkillType.Attack] = true, [SkillType.ProjectileAttack] = true, [SkillType.Area] = true, [SkillType.ProjectileDamage] = true, [SkillType.Type73] = true, [SkillType.SkillCanTotem] = true, [SkillType.SkillCanTrap] = true, [SkillType.SkillCanMine] = true, [SkillType.Vaal] = true, [SkillType.Type89] = true, [SkillType.CantUseFistOfWar] = true, },
	weaponTypes = {
		["Bow"] = true,
	},
	statDescriptionScope = "skill_stat_descriptions",
